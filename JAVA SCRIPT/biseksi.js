    ...
    if(MyPalingKanan > 0){
        ...
        alert('Anda harus memasukan angka');
            ...
            let MyPalingKanann = parseFloat(document.getElementById('InputanPalingKanan').value);
                ...
                {
                    document.write(" <div class='navbar' style='position: relative;background-color: rgb(235, 235, 235);width: 100%;height: 4rem;z-index: 111111;box-shadow: 0 2px 7px .4px rgb(165, 160, 160);margin-bottom : 20px;'><div class='link' style='position: absolute;left: 4rem; margin-top:1rem'> <a href='/HTML/biseksi.html'' style='text-decoration: none;text-align: center;color: #000000;font-weight: 1000;font-family: Arial;'>Back</a></div></div>")
                    if (func(a) * func(b) >= 0)
                    {
...
//------------^ // Not sure but ; is a must in some places.
                            ...
                            document.write("<tbody height = '60px '  style = 'border: 1px solid #dd1010;margin-bottom : 120px'")
                                document.write("<tr style = 'border: 1px solid #dd1010;margin-bottom : 120px'>")
                                    ...
                                    document.write("<td style = 'border: 1px solid #000;text-align : center''>"+func(a).toFixed(4)+"</td>")
                                    document.write("<td style = 'border: 1px solid #000;text-align : center''>"+func(b).toFixed(4)+"</td>")
                                    document.write("<td style = 'border: 1px solid #000;text-align : center''>"+z.toFixed(4)+"</td>")
                                    document.write("<td style = 'border: 1px solid #000;text-align : center''>"+func(z).toFixed(4)+"</td>")
                                document.write("</tr>")
